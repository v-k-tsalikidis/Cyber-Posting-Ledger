"""
Publication-Quality HTML Report Exporter for Cyber Posting Ledger.
Generates standalone, styled HTML assessment briefs with recruiter intelligence (Zero Emojis).
"""

from datetime import datetime, timezone

from cyber_posting_ledger.generator import generate_application_brief
from cyber_posting_ledger.models import CandidateProfile, VacancyRecord
...
<body>
  <div class="report-card">
    ...
    <div class="footer">
      Generated by Cyber Posting Ledger &bull; {

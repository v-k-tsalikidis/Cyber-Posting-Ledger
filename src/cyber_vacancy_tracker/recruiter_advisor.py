...
CERT_DATABASE = {
    CyBOKCategory.GOVERNANCE_RISK: [
        CertificationItem(name="Certified Information Systems Security Professional", code="CISSP", priority="Must-Have"),
        CertificationItem(name="Certified Information Systems Auditor", code="CISA", priority="Recommended"),
        CertificationItem(name="Certified Information Security Manager", code="CISM", priority="Recommended"),
        CertificationItem(name="ISO/IEC 27001 Lead Auditor", code="ISO 27001 LA", priority="Must-Have"),
    ],
    CyBOKCategory.SECURITY_OPERATIONS: [
        CertificationItem(name="GIAC Cyber Threat Intelligence", code="GCTI", priority="Must-Have"),
        CertificationItem(name="GIAC Certified Incident Handler", code="GCIH", priority="Recommended"),
        CertificationItem(name="CompTIA Cybersecurity Analyst", code="CySA+", priority="Recommended"),
        CertificationItem(name="Offensive Security Certified Professional", code="OSCP", priority="Optional"),
    ],
    CyBOKCategory.NETWORK_INFRASTRUCTURE: [
        CertificationItem(name="Certified Information Systems Security Professional", code="CISSP", priority="Must-Have"),
        CertificationItem(name="CompTIA Security+", code="Security+", priority="Must-Have"),
        CertificationItem(name="CCNP Security / Cisco CyberOps", code="CCNP Security", priority="Recommended"),
        CertificationItem(name="NATO Information Assurance Specialist", code="NATO IA", priority="Recommended"),
    ],
    CyBOKCategory.SOFTWARE_SECURITY: [
        CertificationItem(name="Certified Secure Software Lifecycle Professional", code="CSSLP", priority="Must-Have"),
        CertificationItem(name="Certified DevSecOps Professional", code="CDP", priority="Recommended"),
        CertificationItem(name="GIAC Web Application Penetration Tester", code="GWAPT", priority="Recommended"),
    ],
    CyBOKCategory.HUMAN_ORGANIZATIONAL: [
        CertificationItem(name="Certified Information Privacy Professional/Europe", code="CIPP/E", priority="Must-Have"),
        CertificationItem(name="Certified Information Security Manager", code="CISM", priority="Recommended"),
    ],
}
...
def generate_recruiter_advice(vacancy: VacancyRecord, profile: CandidateProfile) -> RecruiterAdvice:
    ...
    from cyber_vacancy_tracker.scoring import classify_cybok_taxonomy
